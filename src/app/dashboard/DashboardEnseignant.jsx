...
const DashboardEnseignant = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      console.error('Error fetching notifications for teacher:', err)
    }
  }
                  ...
                  <div className="mt-1 max-h-60 overflow-y-auto space-y-1">
                    {messages.map((msg) => (
                      <div 
                        ...
                        className={`flex gap-3 items-start p-2.5 rounded-xl transition cursor-pointer hover:bg-emerald-50/40 ${!msg.lu ? 'bg-emerald-50/40' : ''}`}
                      >
                        ...
                        {!msg.lu && <span className="w-2 h-2 rounded-full bg-emerald-500 self-center"></span>}
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mt-1 max-h-60 overflow-y-auto space-y-1">
                    {notifications.map((notif) => (
                      ...
                      >
                        ...
                        {!notif.lu && <span className="w-2 h-2 rounded-full bg-emerald-500 self-center"></span>}
                      </div>
                    ))}
                  </div>
                  <div className="p-1 border-t border-slate-100 mt-2">
